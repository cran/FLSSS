...
// Max, Max + du is aligned with value + dust ~ value + dust + du
{
  ...
  vec<valtype> SRVcntr(d); valtype *SRV = &*SRVcntr.begin();
  ...
  while(true)
  {
    ...
    // {
    //   std::bitset<64> tmpmin(*Min);
    //   std::cout << "Min =      " << tmpmin << "\n";
    //   std::bitset<64> tmpvub(*v[UB[I]]);
    //   std::cout << "v[UB[I]] = " << tmpvub << "\n";
    //   std::bitset<64> tmpSumUB(*sumUB);
    //   std::cout << "sumUB =    " << tmpSumUB << "\n";
    //   std::bitset<64> tmpSR(*SR);
    //   std::cout << "SR =       " << tmpSR << "\n";
    //   std::cout << "\n\n";
    // }
    // {
    //   std::ofstream of("debug.csv", std::ios::app);
    //   {
    //     std::bitset<64> tmp(*Min);
    //     of << "Min =      " << tmp << "\n";
    //   }
    //   {
    //     std::bitset<64> tmp(*v[UB[I]]);
    //     of << "v[UB[I]] = " << tmp << "\n";
    //   }
    //   {
    //     std::bitset<64> tmp(*sumUB);
    //     of << "sumUB =    " << tmp << "\n";
    //   }
    //   {
    //     std::bitset<64> tmp(*SR);
    //     of << "SR =       " << tmp << "\n";
    //   }
    //   of << "\n\n\n\n";
    //   of.close();
    ...
    LBsum = 0;
    {
      ...
      if(LB[I] > UB[I]) {//std::cout << "LB[I] > UB[I]\n";
        return 0;}
      ...
      // std::cout << "1.1 sumLB = " << std::bitset<64>(sumLB[0]) << "\n";
    }
    LBsum += LB[I];
    ...
    // update lower bounds from 1 to the end
    {
      for(; I < len; ++I)
      {
        ...
        // std::cout << "1.2 sumLB = " << std::bitset<64>(sumLB[0]) << "\n";
        LBsum += LB[I];
      }
    }
    ...
    //   std::ofstream of("debug.csv", std::ios::app);
    //   {
    //     std::bitset<64> tmp(*Max);
    //     of << "Max =      " << tmp << "\n";
    //   }
    //   {
    //     std::bitset<64> tmp(*v[LB[I]]);
    //     of << "v[LB[I]] = " << tmp << "\n";
    //   }
    //   {
    //     std::bitset<64> tmp(*sumLB);
    //     of << "sumLB =    " << tmp << "\n";
    //   }
    //   {
    //     std::bitset<64> tmp(*SR);
